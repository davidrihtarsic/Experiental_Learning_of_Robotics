...
1. Construct the mobile robot according to this sequences on the [@fig:construction] and [@fig:construction2].

![Construction sequences (part 1).](./slike/Elora_assembly_1.png){#fig:construction1}

![Construction sequences (part 2).](./slike/Elora_assembly_2.png){#fig:construction2}

Or you can follow the [VIDEO INSTRUCTIONS](https://www.youtube.com/watch?v=XgpEFWoUelA)
